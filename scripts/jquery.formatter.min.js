...
!function (a, b) {
  ...
  var a = function () {
      ...
      b = function () {
    {
      ...
      for (var d in c) {
        var e = c[d];if (a === e.which && b === e.keyCode) return d;
      }
    }, a.isDelKeyDown = function (b, c) {
      var d = { backspace: { which: 8, keyCode: 8 }, 'delete': { which: 46, keyCode: 46 } };return a.getMatchingKey(b, c, d);
    }, a.isDelKeyPress = function (b, c) {
      var d = { backspace: { which: 8, keyCode: 8, shiftKey: !1 }, 'delete': { which: 0, keyCode: 46 } };return a.getMatchingKey(b, c, d);
    }, a.isSpecialKeyPress = function (b, c) {
      var d = { tab: { which: 0, keyCode: 9 }, enter: { which: 13, keyCode: 13 }, end: { which: 0, keyCode: 35 }, home: { which: 0, keyCode: 36 }, leftarrow: { which: 0, keyCode: 37 }, uparrow: { which: 0, keyCode: 38 }, rightarrow: { which: 0, keyCode: 39 }, downarrow: { which: 0, keyCode: 40 }, F5: { which: 116, keyCode: 116 } };return a.getMatchingKey(b, c, d);
    }, a.isModifier = function (a) {
      return a.ctrlKey || a.altKey || a.metaKey;
    }, a.forEach = function (a, b, c) {
      if (a.hasOwnProperty('length')) for (var d = 0, e = a.length; e > d && b.call(c, a[d], d, a) !== !1; d++) {} else for (var f in a) {
    ...
    function c(c) {
      var e = [],
          f = [];b.forEach(c, function (c) {
        b.forEach(c, function (b, c) {
          var g = a.parse(b),
              h = d(c);return e.push(h), f.push(g), !1;
        });
      });var g = function g(a) {
        var c;return b.forEach(e, function (b, d) {
      ...
      d = function () {
    var a = {};return a.get = function (a) {
      if ('number' == typeof a.selectionStart) return { begin: a.selectionStart, end: a.selectionEnd };var b = document.selection.createRange();if (b && b.parentElement() === a) {
        var c = a.createTextRange(),
            d = a.createTextRange(),
            e = a.value.length;return c.moveToBookmark(b.getBookmark()), d.collapse(!1), c.compareEndPoints('StartToEnd', d) > -1 ? { begin: e, end: e } : { begin: -c.moveStart('character', -e), end: -c.moveEnd('character', -e) };
      }return { begin: 0, end: 0 };
    }, a.set = function (a, b) {
      if ('object' != (typeof b === 'undefined' ? 'undefined' : _typeof(b)) && (b = { begin: b, end: b }), a.setSelectionRange) a.focus(), a.setSelectionRange(b.begin, b.end);else if (a.createTextRange) {
        var c = a.createTextRange();c.collapse(!0), c.moveEnd('character', b.end), c.moveStart('character', b.begin), c.select();
      }
    }, a;
  }(),
      e = function (a, b, c) {
    function d(b, d) {
      var f = this;if (f.el = b, !f.el) throw new TypeError('Must provide an existing element');if (f.opts = c.extend({}, e, d), 'undefined' != typeof f.opts.pattern && (f.opts.patterns = f._specFromSinglePattern(f.opts.pattern), delete f.opts.pattern), 'undefined' == typeof f.opts.patterns) throw new TypeError('Must provide a pattern or array of patterns');f.patternMatcher = a(f.opts.patterns), f._updatePattern(), f.hldrs = {}, f.focus = 0, c.addListener(f.el, 'keydown', function (a) {
        f._keyDown(a);
        ...
        f = { 9: /[0-9]/, a: /[A-Za-z]/, '*': /[A-Za-z0-9]/ };return d.addInptType = function (a, b) {
      f[a] = b;
    }, d.prototype.resetPattern = function (c) {
      this.opts.patterns = c ? this._specFromSinglePattern(c) : this.opts.patterns, this.sel = b.get(this.el), this.val = this.el.value, this.delta = 0, this._removeChars(), this.patternMatcher = a(this.opts.patterns);var d = this.patternMatcher.getPattern(this.val);this.mLength = d.mLength, this.chars = d.chars, this.inpts = d.inpts, this._processKey('', !1, !0);
    }, d.prototype._updatePattern = function () {
      var a = this.patternMatcher.getPattern(this.val);a && (this.mLength = a.mLength, this.chars = a.chars, this.inpts = a.inpts);
    }, d.prototype._keyDown = function (a) {
      var b = a.which || a.keyCode;return b && c.isDelKeyDown(a.which, a.keyCode) ? (this._processKey(null, b), c.preventDefault(a)) : void 0;
    }, d.prototype._keyPress = function (a) {
      var b, d;return b = a.which || a.keyCode, d = c.isSpecialKeyPress(a.which, a.keyCode), c.isDelKeyPress(a.which, a.keyCode) || d || c.isModifier(a) ? void 0 : (this._processKey(String.fromCharCode(b), !1), c.preventDefault(a));
      ...
      var a = this;setTimeout(function () {
        var c = b.get(a.el),
            d = c.end > a.focus,
            e = 0 === c.end;(d || e) && b.set(a.el, a.focus);
      }, 0);
      ...
      this.sel.end > this.focus && (this.delta += this.sel.end - this.focus);for (var a = 0, b = 0; b <= this.mLength; b++) {
        var d,
            e = this.chars[b],
            f = this.hldrs[b],
            g = b + a;g = b >= this.sel.begin ? g + this.delta : g, d = this.val.charAt(g), (e && e === d || f && f === d) && (this.val = c.removeChars(this.val, g, g + 1), a--);
      ...
      for (var a = 0; a < this.val.length; a++) {
        var b = this.inpts[a],
            ...
            g = this.inpts[a];(d || e) && g && (this.val = c.removeChars(this.val, a, a + 1), this.focusStart--, this.newPos--, this.delta--, a--);
      }
      ...
      if (this.opts.persistent) {
        ...
        if (this.delta <= 0 && b === this.focus) return !0;this._addChar(b);
      }
    }, d.prototype._addChar = function (a) {
      var b = this.chars[a];return b ? (c.isBetween(a, [this.sel.begin - 1, this.newPos + 1]) && (this.newPos++, this.delta++), a <= this.focus && this.focus++, this.hldrs[a] && (delete this.hldrs[a], this.hldrs[a + 1] = this.opts.placeholder), void (this.val = c.addChars(this.val, b, a))) : !0;
    }, d.prototype._specFromSinglePattern = function (a) {
      return [{ '*': a }];
    }, d;
  }(c, d, b),
      f = 'formatter';$.fn[f] = function (a) {
    return 'object' == (typeof a === 'undefined' ? 'undefined' : _typeof(a)) && this.each(function () {
      $.data(this, 'plugin_' + f) || $.data(this, 'plugin_' + f, new e(this, a));
    }), this.resetPattern = function (a) {
      return this.each(function () {
        var b = $.data(this, 'plugin_' + f);b && b.resetPattern(a);
      }), this;
    }, this;
